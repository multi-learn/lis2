...
class UNet(nn.Module):
    """
    UNet implementation with batch normalization.
    ...
    def __init__(self, in_channels=1, out_channels=1, init_features=64):
        ...
        self.pool1 = nn.MaxPool2d(
            kernel_size=UNet._MAX_POOL_KERNEL_SIZE, stride=UNet._MAX_POOL_STRIDE
        )
        ...
        self.upconv4 = nn.ConvTranspose2d(
            16 * features,
            features * 8,
            kernel_size=UNet._UPCONV_KERNEL_SIZE,
            stride=UNet._UPCONV_STRIDE,
        )
                ...
                [
                    (
                        ...
                        nn.Conv2d(
                            ...
                            kernel_size=UNet._CONV_KERNEL_SIZE,
                            padding=UNet._CONV_PADDING,
                            bias=False,
                        ),
                    ),
