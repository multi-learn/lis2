...
Code from https://github.com/mateuszbuda/brain-segmentation-pytorch/blob/master/UNet2.py
"""
...
class UNet2(nn.Module):
    """
    UNet2 implementation with batch normalization.
    ...
    def __init__(self, in_channels=2, out_channels=1, init_features=64):
        ...
        self.pool1 = nn.MaxPool2d(
            kernel_size=UNet2._MAX_POOL_KERNEL_SIZE, stride=UNet2._MAX_POOL_STRIDE
        )
        ...
        self.upconv4 = nn.ConvTranspose2d(
            16 * features,
            features * 8,
            kernel_size=UNet2._UPCONV_KERNEL_SIZE,
            stride=UNet2._UPCONV_STRIDE,
        )
                ...
                [
                    (
                        ...
                        nn.Conv2d(
                            ...
                            kernel_size=UNet2._CONV_KERNEL_SIZE,
                            padding=UNet2._CONV_PADDING,
                            bias=False,
                        ),
                    ),
