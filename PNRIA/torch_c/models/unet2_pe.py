"""UNet2_pe implementation.

Code from https://github.com/mateuszbuda/brain-segmentation-pytorch/blob/master/UNet2_pe.py
"""
...
class UNet2_pe(nn.Module):
    """
    UNet2_pe implementation with batch normalization.
    ...
    def __init__(self, in_channels=2, out_channels=1, init_features=64):
        ...
        self.pool1 = nn.MaxPool2d(
            kernel_size=UNet2_pe._MAX_POOL_KERNEL_SIZE, stride=UNet2_pe._MAX_POOL_STRIDE
        )
        ...
        self.upconv4 = nn.ConvTranspose2d(
            16 * features + 2, # +2 correspond to the position encoding tensor
            features * 8,
            kernel_size=UNet2_pe._UPCONV_KERNEL_SIZE,
            stride=UNet2_pe._UPCONV_STRIDE,
        )
                ...
                [
                    (
                        ...
                        nn.Conv2d(
                            ...
                            kernel_size=UNet2_pe._CONV_KERNEL_SIZE,
                            padding=UNet2_pe._CONV_PADDING,
                            bias=False,
                        ),
                    ),
