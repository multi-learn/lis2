"""UNet_pe_atl implementation.

Code from https://github.com/mateuszbuda/brain-segmentation-pytorch/blob/master/UNet_pe_atl.py
"""
...
class UNet_pe_atl(nn.Module):
    """
    UNet_pe_atl_pe implementation with batch normalization.
    ...
    def __init__(self, in_channels=1, out_channels=1, init_features=64, encoding="sym"):
        ...
        self.pool1 = nn.MaxPool2d(
            kernel_size=UNet_pe_atl._MAX_POOL_KERNEL_SIZE, stride=UNet_pe_atl._MAX_POOL_STRIDE
        )
        ...
        self.upconv4 = nn.ConvTranspose2d(
            16 * features, # +2 correspond to the 2 values of the position encoding
            features * 8,
            kernel_size=UNet_pe_atl._UPCONV_KERNEL_SIZE,
            stride=UNet_pe_atl._UPCONV_STRIDE,
        )
    ...
    def forward(self, x, position):
        ...
        dec1 = torch.cat((dec1, position), dim=1)
                ...
                [
                    (
                        ...
                        nn.Conv2d(
                            ...
                            kernel_size=UNet_pe_atl._CONV_KERNEL_SIZE,
                            padding=UNet_pe_atl._CONV_PADDING,
                            bias=False,
                        ),
                    ),
    ...
    def position_encoding(self, positions):
        if self.get_pe() == "sin":
            ...
            pe_x = positions[:,1,0] / 114000
            pe_y = positions[:,0,0] / 1800
