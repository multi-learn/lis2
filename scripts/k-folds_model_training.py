...
if __name__ == "__main__":
    ...
    train_dataset_files = utils.get_sorted_file_list(args.train_path)
    test_dataset_files = utils.get_sorted_file_list(args.test_path)
    ...
    for i in range(len(train_dataset_files)):
        ...
        train_procedure(args.folder_name,
                        ...
                        args.model,
                        os.path.join(args.train_path, train_dataset_files[i]),
                        os.path.join(args.test_path, test_dataset_files[i]),
